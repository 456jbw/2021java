...
public class ShapeEqualTri extends Shape{
    ...
    /**
     * 等腰三角形的构造类
     * @param color 等腰三角形的颜色
     * @param stroke 等腰三角形的宽度
     */
    public ShapeEqualTri(Color color, Stroke stroke){
        super(color, stroke);
    }

    /**
     * 当鼠标按下之后,将会设置按下去的位置为等腰三角形的左上角坐标
