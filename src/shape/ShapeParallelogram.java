...
public class ShapeParallelogram extends Shape{
    ...
    /**
     * 平行四边形的构造类
     * @param color 平行四边形的颜色
     * @param stroke 平行四边形的宽度
     */
    public ShapeParallelogram(Color color, Stroke stroke){
        super(color, stroke);
    }

    /**
     * 当鼠标按下之后,将会设置按下去的位置为矩形的平行四边形坐标
